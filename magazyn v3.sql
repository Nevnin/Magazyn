...
--
-- Host: 127.0.0.1
-- Czas generowania: 10 Kwi 2017, 19:41
...
(1, '2017-03-21', '2017-03-20', 600, 1, '2017-03-20', '2017/03/20/1', 'Odbior osobity', 0, 800),
...
--
ALTER TABLE `zamowienie`
  MODIFY `IdZamowienie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT dla tabeli `zamowienietowar`
--
ALTER TABLE `zamowienietowar`
  MODIFY `IdZamowienieTowar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
